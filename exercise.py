...
def check_voting_eligibility():
    ...
    try:
        ...
        if age < 0:
            ...
            voting_age = 18  # Set the voting age
            if age >= voting_age:
...
def determine_season():
    ...
    try:
        ...
        if not 1 <= day <= 31:
            print("Invalid day of the month. Please enter a number between 1 and 31.")
            return
        
        # Mapping of months to seasons based on specific date ranges
        if (month == 'Dec' and day >= 21) or (month in ('Jan', 'Feb')) or (month == 'Mar' and day < 20):
            ...
            print("Invalid date. Please check your inputs and try again.")
            return
        
        print(f"{month} {day} is in {season}.")
    except ValueError:
        print("Invalid input for day. Please enter a numeric value.")
